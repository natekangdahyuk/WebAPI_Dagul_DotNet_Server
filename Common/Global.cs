...
namespace Common
{
    public class Global : Common.Page.Base
    {
        ...
        //프로젝트 이름 설정
        public static string ProjectName = "CARGO";

        //쿠키 설정
        public static string CookieDomain = "api.codlabs.com";

        //사이트 파일 업로드 폴더
        public static string FileUploadPath = "D:\\wwwRoot\\uploadFiles\\codLabs\\";// 진짜 파일이 업로드 되는곳
        public static string FileUploadPathTemp = "D:\\wwwRoot\\uploadFiles\\codLabs\\Temp\\";// 임시로 저장하고 수정하는 곳
